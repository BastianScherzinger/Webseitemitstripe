...
from .shop import startseite, werbung_klick, kontakt, kontakte, ueber_uns, produkte, produkt_detail
...
__all__ = [
    # shop
    'startseite', 'werbung_klick', 'kontakt', 'kontakte', 'ueber_uns', 'produkte', 'produkt_detail',
    # auth
