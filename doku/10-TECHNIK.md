...
| Punkt | Beleg | Regel |
|---|---|---|
| Zweig `sofort/2026-09-17-pj05-und-2-weitere` erneut nach `main` mergen und pushen (zwei Commits vor `f8643f0`); danach mit einem Bildschirmleser eine Fehlermeldung auf `/kontakt/` auslösen | `a708c7f`, `a8190b8` — `BF24` ist nur als Attribut im gerenderten HTML getestet | PJ05, BF24 |
