...
| Punkt | Beleg | Regel |
|---|---|---|
| Zweig `sofort/2026-09-12-vl21-und-2-weitere` nach `main` mergen und pushen (`sofort/2026-09-11-kv07-und-2-weitere` ist mit `c522ff9` gemergt, `main` = `origin/main` = `4f91ac9`); danach einmal das Kontaktformular live abschicken | `5f517de`, ein Commit vor `main`; am gerenderten HTML ändert er nichts | VL21, KV07 |
