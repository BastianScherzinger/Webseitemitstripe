...
status: teilweise
fortschritt: 70
zusammenfassung: Gesamtstand 76,5 „Solide“ (04.09.2026). Verbesserungslauf 4, SU04 und GE23/GE25/IS19 liegen auf origin/main; drei belegte Wissensbeiträge, Antwortabsätze mit belegten Zahlen, keine dünne Seite mehr. PJ05 (kritische Audit-Funde abgearbeitet oder begründet), SI08 (CSP blockiert) und PJ11 (Paketfassungen samt Lockfile) sind seit dem Merge 0c18ea7, SI09 (Nonce statt 'unsafe-inline' im script-src, im Browser ungeprüft) seit 4ec540b, IS18 (Startseite, Produktübersicht und Wissensübersicht laut Commit im Umfang ihrer Seitenart) seit 1a5f36b und KV07 (Danke-Seite /kontakt/danke/) samt der VL01-Ausnahme seit c522ff9 auf main und origin/main (beide 4f91ac9). Auf dem Zweig sofort/2026-09-12-vl21-und-2-weitere (ein Commit, nicht gemergt) liegt die Produktkarte als zwei Bausteine unter shop1/templates/shop1/teile/, ohne eine Änderung am gerenderten HTML (VL21, anders eingebaut). GE11 wartet auf Profiladressen der Betreiberin, RE07 auf Schriftdateien und einen Lauf mit Netzzugang. TS11 wartet weiter auf CANONICAL_HOST. Die drei ersten Beiträge und die Produktbeschreibungen warten auf die Betreiberin.
offen: 3
...
| **Ordner-Stand** | Zweig `sofort/2026-09-12-vl21-und-2-weitere` @ `5f517de` (12.09.2026), ein Commit vor `main` (`5f517de` VL21 — zwei neue Vorlagenbausteine, gerendertes HTML unverändert), nicht gemergt und in keinem Remote-Zweig. `sofort/2026-09-11-kv07-und-2-weitere` ist mit `c522ff9`, `sofort/2026-09-11-is18` mit `1a5f36b`, `sofort/2026-09-11-si09` mit `4ec540b`, `sofort/2026-09-11-pj05-und-2-weitere` mit `0c18ea7` in `main` gemergt; `main` = `origin/main` = `4f91ac9` (lokale Referenz, geprüft 12.09.2026). `cockpit/2026-09-01-verbesserung-4` (`511ffe5`) ist in `origin/main` enthalten — die Zeile „Live-Stand" darüber ist damit überholt (siehe eigener Punkt `EIG11` in [80-AUFGABEN.md](80-AUFGABEN.md)) |
...
| Aufgaben | teilweise | 50 | SU04, GE23, GE25, IS19, PJ05, SI08, PJ11, SI09, IS18 und seit dem Merge `c522ff9` auch KV07 und VL01 liegen auf main und origin/main (beide `4f91ac9`, lokale Referenz; ob Railway ausgeliefert hat, ist nicht geprüft; SI09 und die Danke-Seite im Browser ungeprüft). Paket 183 (12.09.2026, Zweig `sofort/2026-09-12-vl21-und-2-weitere`, ein Commit `5f517de`, nicht gemergt) bringt VL21 anders eingebaut: die Produktkarte liegt als zwei Bausteine unter `shop1/templates/shop1/teile/` und wird von Startseite und Produktübersicht per include eingebunden, gerendertes HTML unverändert, 224/224 Tests grün laut Commit. GE11 und RE07 im selben Paket nicht möglich — für `sameAs` fehlen die Profiladressen der Betreiberin, für die eigenen Schriften liegen keine WOFF2-Dateien im Projekt und der Lauf hatte keinen Netzzugang. Nächster Schritt ist der Merge dieses Zweigs, danach Nachmessung, Bezahlseite und Ersatzskripte mit offener Browserkonsole und der erste CI-Lauf mit Django 5.2.17; Schriften lokal, Sprungmarke, Icon-Knöpfe, Permissions-Policy und die Freigaben der Betreiberin bleiben offen. | [80-AUFGABEN.md](80-AUFGABEN.md) |
